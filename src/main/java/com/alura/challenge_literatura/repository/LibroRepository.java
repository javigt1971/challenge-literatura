...
public interface LibroRepository extends JpaRepository<Libro,Long> {
    ...
    Optional<com.alura.challenge_literatura.model.Libro> obtenerLibroPorNombre(String nombre);

    @Query("SELECT l FROM Libro l WHERE l.idioma=:idioma")
    List<com.alura.challenge_literatura.model.Libro> obtenerLibrosPorIdioma(Idioma idioma);
}